...
import 'package:ocr_project/src/widgets/picker_option_widget.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          const Text('Select a Option', style: TextStyle(fontSize: 22.0)),
            ...
            child: Row(
              ...
              children: [
                ...
                PickerOptionWidget(
                  ...
                  onTap: () =>
                      _processImageExtractText(imageSource: ImageSource.camera),
                ),
              ],
            ),
          ),

...
class PembatalanKeretaPagefwcKai extends StatefulWidget {
  ...
  @override
  State<PembatalanKeretaPagefwcKai> createState() => _HistoryDeletePageState();
}

class _HistoryDeletePageState extends State<PembatalanKeretaPagefwcKai> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'Riwayat Pembatalan Kereta FWCKAI',
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  const Text(
                    'Riwayat Pembatalan Kerata FWCKAI',

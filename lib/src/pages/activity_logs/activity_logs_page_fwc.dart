...
class ActivityLogsPagefwc extends StatefulWidget {
  final String userName;
  final String roleName;
  final RoleAccess roleAccess;

  const ActivityLogsPagefwc({
    super.key,
  ...
  @override
  State<ActivityLogsPagefwc> createState() => _ActivityLogsPageState();
}

class _ActivityLogsPageState extends State<ActivityLogsPagefwc> {
  ...
  Future<void> loadLogs() async {
    await controller.loadLogs(product: "FWC");
    if (mounted) {
      setState(() {

...
class ActivityLogsPagefwckai extends StatefulWidget {
  final String userName;
  final String roleName;
  final RoleAccess roleAccess;
  final String roleCode;

  const ActivityLogsPagefwckai({
    super.key,
  ...
  @override
  State<ActivityLogsPagefwckai> createState() => _ActivityLogsPageState();
}

class _ActivityLogsPageState extends State<ActivityLogsPagefwckai> {
  ...
  Future<void> loadLogs() async {
    await controller.loadLogs(product: "FWCKAI");
